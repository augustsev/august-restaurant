  ...
  <div class="topbar">
    <div class="container">
      ...
      <address class="topbar-item">
        ...
        <span class="span">
          Restaurant St, Dusun Trini, Yogyakarta, Indonesia
        </span>
      </address>
      ...
      <div class="topbar-item item-2">
        ...
        <span class="span">Open : 8.00 WIB to 22.00 WIB</span>
      </div>
      ...
      <a href="tel:+11234567890" class="topbar-item link">
        ...
        <span class="span">+628 9637 865226</span>
      </a>

      <div class="separator"></div>

      <a href="mailto:augustsevenn@gmail.com" class="topbar-item link">
        <div class="icon">
          <ion-icon name="mail-outline" aria-hidden="true"></ion-icon>
        </div>

        <span class="span">augustsevenn@gmail.com</span>
      </a>
    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <div class="text-center">
          ...
          <a href="mailto:augustsevenn@gmail.com" class="body-4 sidebar-link">augustsevenn@gmail.com</a>

          <div class="separator"></div>

          <p class="contact-label">Booking Request</p>

          <a href="tel:+628 9637 865226" class="body-1 contact-number hover-underline">
            +628 9637 865226
          </a>
        </div>
    ...
    <article>
      ...
      <section class="section service bg-black-10 text-center" aria-label="service">
        <div class="container">
          ...
          <h2 class="headline-1 section-title">Menu Utama</h2>

          <p class="section-text">
            Rasa Yang Tidak Ada Dua Nya
          </p>
      ...
      <section class="section about text-center" aria-labelledby="about-label" id="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <h2 class="headline-1 section-title">Grilli Restaurant</h2>

            <p class="section-text">
              Berdiri Sejak 1978, Dengan Menu Hidangan Menggugah Selera.
              Bertemakan Eropa Dan Menu Eropa Serta Asia.
            </p>

            <div class="contact-label">Book Through Call</div>

            <a href="tel:+804001234567" class="body-1 contact-number hover-underline">+628 9637 865226</a>
      ...
      <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <h2 class="headline-1 section-title">Lobster Italian</h2>

            <p class="section-text">
              Hidangan Utama Yang Sedang Promo 1 Januari - 20 Januari.
              Buruan, Jangan Sampai Ketinggalan Promo.
            </p>

            <div class="wrapper">
              <del class="del body-3">Rp 40.000</del>

              <span class="span body-1">Rp 20.000</span>
            </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Rp 18.000</span>
                  </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Rp 25.000</span>
                  </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Rp 22.000</span>
                  </div>
              ...
              <div class="menu-card hover:card">
                ...
                <div>
                  ...
                  <div class="title-wrapper">
                    ...
                    <span class="span title-2">Rp 30.000</span>
                  </div>
      ...
      <section class="section testi text-center has-bg-image"
        ...
        <div class="container">
          ...
          <p class="headline-2 testi-text">
            Saya ingin mengucapkan terima kasih karena telah mengundang saya untuk makan malam yang luar biasa tadi malam. Makanannya tadi
            luar biasa.
          </p>
          ...
          <div class="profile">
            <img src="./assets/images/arnold.jpg" width="100" height="100" loading="lazy" alt="Sam Jhonson"
              class="img">

            <p class="label-2 profile-name">Arnold Poernomo</p>
          </div>
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <form action="" class="form-left">
              ...
              <p class="form-text text-center">
                Booking request <a href="tel:+628 9637 865226" class="link">+628 9637 865226</a>
              ...
              <div class="input-wrapper">
                ...
                <div class="icon-wrapper">
                  ...
                  <select name="person" class="input-field">
                    <option value="08:00WIB">08 : 00 WIB</option>
                    <option value="09:00WIB">09 : 00 WIB</option>
                    <option value="010:00WIB">10 : 00 WIB</option>
                    <option value="011:00WIB">11 : 00 WIB</option>
                    <option value="012:00WIB">12 : 00 WIB</option>
                    <option value="13:00WIB">13 : 00 WIB</option>
                    <option value="14:00WIB">14 : 00 WIB</option>
                    <option value="15:00WIB">15 : 00 WIB</option>
                    <option value="16:00WIB">16 : 00 WIB</option>
                    <option value="17:00WIB">17 : 00 WIB</option>
                    <option value="18:00WIB">18 : 00 WIB</option>
                    <option value="19:00WIB">19 : 00 WIB</option>
                    <option value="20:00WIB">20 : 00 WIB</option>
                    <option value="21:00WIB">21 : 00 WIB</option>
                    <option value="22:00WIB">22 : 00 WIB</option>
                  </select>
            ...
            <div class="form-right text-center" style="background-image: url('./assets/images/form-pattern.png')">
              ...
              <a href="tel:+628 9637 865226" class="body-1 contact-number hover-underline">+628 9637 865226</a>
          ...
          <ul class="grid-list">
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <p class="label-1 card-text">Telah Teruji Bebas Dari Kotoran Dan Bersih.</p>
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <p class="label-1 card-text">Makanan Fresh. <br>Masak Langsung.</p>
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <p class="label-1 card-text">Kami Memiliki <br>Chef Ternama Juna Rorimpandey.</p>
            ...
            <li class="feature-item">
              <div class="feature-card">
                ...
                <p class="label-1 card-text">Selalu Mengadakan Event Dan Party Untuk Pelanggan.</p>
    ...
    <div class="container">
      ...
      <div class="footer-top grid-list">
        ...
        <div class="footer-brand has-before has-after">
          ...
          <a href="mailto:augustsevenn@gmail.com" class="body-4 contact-link">augustsevenn@gmail.com</a>

          <a href="tel:+628 9637 865226" class="body-4 contact-link">Booking Request : +628 9637 865226</a>

          <p class="body-4">
            Open : 08:00 WIB - 22:00 WIB
          </p>
        ...
        <ul class="footer-list">
          ...
          <li>
            <a href="https://www.facebook.com/Tokyooo21#" class="label-2 footer-link hover-underline">Facebook</a>
          </li>

          <li>
            <a href="https://www.instagram.com/_lahwann" class="label-2 footer-link hover-underline">Instagram</a>
          </li>

          <li>
            <a href="https://Wa.me/6289637865226" class="label-2 footer-link hover-underline">Whatsapp</a>
          </li>
